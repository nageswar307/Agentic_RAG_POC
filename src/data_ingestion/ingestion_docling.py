...
import os
workspace_root = Path(os.path.dirname(__file__)).parent.parent  # Get to project root
input_dir = workspace_root / "data" / "raw"
output_root = workspace_root / "data" / "processed"
