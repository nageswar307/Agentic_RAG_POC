...
def document_retrieval_tool(query: Union[str, Dict[str, Any]]) -> str:
    ...
    try:
        ...
        tables_to_try = [
            "doc_md_simple_20250830",      # Our new simple table
            "doc_md_contextual_20250830",  # Original contextual table
            "doc_md_20250830_015134"       # Fallback table
        ]
        ...
        for table_name in tables_to_try:
            try:
                ...
                print(f"DEBUG: Successfully connected to table: {table_name}")
                break
            except Exception as e:
                print(f"DEBUG: Table {table_name} not available: {e}")
                continue
